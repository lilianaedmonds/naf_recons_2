...
dcf_bins = save_data_helpers.read_pickle('/data/lilianae/data_and_spoke_bins/dcf_ksp_100sp_phil_gating_512_5gates.pkl')
...
admm_configs = [{'rho': 1e-2, 'beta': 1e-4, 'tv_lamda': 1e-3, 'name': 'original'},       ## Original configuration - okay results
           {'rho': 1e-2, 'beta': 5e-3, 'tv_lamda': 7e-3, 'name': 'high_beta_tv'},       ## Original config, 
           {'rho': 5e-2, 'beta': 5e-4, 'tv_lamda': 5e-3, 'name': 'strong_coupling'},       ## Stronger lamda for TV regularization, stronger coupling between subproblems          
           {'rho': 0.1, 'beta': 1e-3, 'tv_lamda' : 5e-3, 'name': 'very_strong'}]       ## Very strong coupling, slightly stronger regularization


motion_configs = [{'motion_base': 'z'}, {'motion_base': 'zu_lam'}]
